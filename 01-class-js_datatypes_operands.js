...
betterCappuccino = "its really just coffee";
console.log(betterCappuccino);


// JS basic operators
console.log("<<< assign >>>", betterCappuccino = "ok, thats enough");
console.log("<<< equality >>>", betterCappuccino == "ok, thats enough");
...
console.log("Is 6 a multiple of 3? -> ", 64877927 % 2 === 0);//this shows if a number is even
console.log("Is 6 a multiple of 3? -> ", 64877927 % 2 !== 0);//this shows if a number is odd
console.log("Is 6 a multiple of 3? -> ", !(64877927 % 2 === 0));//this shows if a number is odd
...
console.log(withSubstring); // <== Don: returns string neetween first and last index
